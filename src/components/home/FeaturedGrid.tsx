...
const layouts = [
  { width: "85%", justify: "flex-start" as const },
  { width: "60%", justify: "flex-end" as const },
  { width: "70%", justify: "center" as const },
  { width: "55%", justify: "flex-start" as const },
  { width: "65%", justify: "flex-end" as const },
];
